...
set xtics rotate ( \
 "CP100397.1" 1.0, \
 "CP100398.1" 9108208.0, \
 "" 9619655 \
)
set ytics ( \
 "contig_3_pilon" 1.0, \
 "contig_1_pilon" 551129.0, \
 "*contig_4_pilon" 7547156.0, \
 "*contig_2_pilon" 8601593.0, \
 "" 8772056 \
)
set size 1,1
set grid
...
set xrange [1:9619655]
set yrange [1:8772056]
set style line 1  lt 1 lw 2 pt 6 ps 1
set style line 2  lt 3 lw 2 pt 6 ps 1
set style line 3  lt 2 lw 2 pt 6 ps 1
plot \
 "HP126_mummerplot.fplot" title "FWD" w lp ls 1, \
 "HP126_mummerplot.rplot" title "REV" w lp ls 2
